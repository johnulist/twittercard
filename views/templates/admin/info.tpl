                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div id="mc_embed_signup">
                                        <form action="//strikehawk.us8.list-manage.com/subscribe/post?u=b3d6d6ba3f9182a0a36ba0052&amp;id=5374327a0f" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                                            <div id="mc_embed_signup_scroll">
                                                ...
                                                <div class="mc-field-group input-group">
                                                    ...
                                                    <ul><li><input type="checkbox" value="1" name="group[11653][1]" id="mce-group[11653]-11653-0"><label for="mce-group[11653]-11653-0">PrestaShop</label></li>
                                                        <li><input type="checkbox" value="4" name="group[11653][4]" id="mce-group[11653]-11653-1"><label for="mce-group[11653]-11653-1">WordPress</label></li>
                                                        <li><input type="checkbox" value="8" name="group[11653][8]" id="mce-group[11653]-11653-2"><label for="mce-group[11653]-11653-2">osCommerce</label></li>
                                                        <li><input type="checkbox" value="2" name="group[11653][2]" id="mce-group[11653]-11653-3"><label for="mce-group[11653]-11653-3">CRE Loaded</label></li>
                                                        <li><input type="checkbox" value="16" name="group[11653][16]" id="mce-group[11653]-11653-4"><label for="mce-group[11653]-11653-4">Web Hosting Tips</label></li>
                                                    </ul>
                                                </div>
                                                <div class="mc-field-group input-group">
                                                ...
                                                <p><a href="http://us8.campaign-archive1.com/home/?u=b3d6d6ba3f9182a0a36ba0052&id=5374327a0f" title="View previous campaigns">View previous campaigns.</a></p>
                                                <p>Powered by <a href="http://eepurl.com/TqyPL" title="MailChimp - email marketing made easy and fun">MailChimp</a></p>
                                                <div id="mce-responses" class="clear">
                                                    <div class="response" id="mce-error-response" style="display:none"></div>
                                                    <div class="response" id="mce-success-response" style="display:none"></div>
                                                </div>    <!-- real people should not fill this in and expect good things - do not remove this or risk form bot signups-->
                                                <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_b3d6d6ba3f9182a0a36ba0052_5374327a0f" tabindex="-1" value=""></div>
